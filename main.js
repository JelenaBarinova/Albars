...
throw new Error(message);}catch(x) {}}};}module.exports = warning;}).call(this,require('_process'));},{"./emptyFunction":121,"_process":3}],162:[function(require,module,exports){module.exports = require('./lib/React');},{"./lib/React":35}],163:[function(require,module,exports){"use strict";var Dispatcher=require('../dispatcher/dispatcher.js');var ActionTypes=require('../constants/action-types.js');var Api=require('../api/api.js');var InitializeActions={initApp:function initApp(){Dispatcher.dispatch({actionType:ActionTypes.INITIALIZE,initialData:{content:Api.getData('en_US')}});}};module.exports = InitializeActions;},{"../api/api.js":164,"../constants/action-types.js":166,"../dispatcher/dispatcher.js":167}],164:[function(require,module,exports){"use strict";var $=require('jquery');var Api={getData:function getData(language){var _content={};if(language == 'ru_RU'){_content = require('../../data/ru_RU.json');}else {_content = require('../../data/en_US.json');}return _content;}};module.exports = Api;},{"../../data/en_US.json":1,"../../data/ru_RU.json":2,"jquery":7}],165:[function(require,module,exports){"use strict";var React=require('react');var App=React.createClass({displayName:"App",render:function render(){return React.createElement("div",null,React.createElement("h2",null,"Initialize action is being done"),React.createElement("h3",null,"Additional javascript libs removed"));}});module.exports = App;},{"react":162}],166:[function(require,module,exports){"use strict";var keyMirror=require('react/lib/keyMirror');module.exports = keyMirror({INITIALIZE:null,SWITCH_LANGUAGE:null});},{"react/lib/keyMirror":147}],167:[function(require,module,exports){"use strict";var Dispatcher=require('flux').Dispatcher;module.exports = new Dispatcher();},{"flux":4}],168:[function(require,module,exports){"use strict";var React=require('react');var App=require('./components/app.jsx');var InitializeActions=require('./actions/initialize-actions.js');InitializeActions.initApp();React.render(React.createElement(App,null),document.getElementById('HomePage'));},{"./actions/initialize-actions.js":163,"./components/app.jsx":165,"react":162}]},{},[168]); // Otherwise append directly