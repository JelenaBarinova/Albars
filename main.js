...
throw new Error(message);}catch(x) {}}};}module.exports = warning;}).call(this,require('_process'));},{"./emptyFunction":115,"_process":1}],156:[function(require,module,exports){module.exports = require('./lib/React');},{"./lib/React":29}],157:[function(require,module,exports){"use strict";var React=require('react'); /*
...
*/var App=React.createClass({displayName:"App",render:function render(){return React.createElement("h1",null,"Hello, world!");}});module.exports = App;},{"react":156}],158:[function(require,module,exports){"use strict";var React=require('react');var App=require('./components/app.jsx'); //React.render(<App />, document.getElementById('HomePage'));
React.render(React.createElement(App,null),document.getElementById('HomePage'));},{"./components/app.jsx":157,"react":156}]},{},[158]);